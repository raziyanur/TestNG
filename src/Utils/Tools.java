...
public class Tools {
    ...
    public static void successMessageValidation(){
        WebElement yesilYaziDogrul=GenelWebDriver.driver.findElement(By.xpath("//*[@class='alert alert-success alert-dismissible']"));
        Assert.assertTrue(yesilYaziDogrul.getText().toLowerCase().contains("success"));
