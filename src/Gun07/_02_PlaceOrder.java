...
public class _02_PlaceOrder extends GenelWebDriver {
    ...
    void ProceedToCheckout() {
        ...
        //WebElement addToCart = driver.findElement(By.cssSelector("[onclick='cart.add('48', '1');']"));
        WebElement addToCart= driver.findElement(By.className("button-group"));
        addToCart.click();

        WebElement shoppingCart = driver.findElement(By.xpath("//*[@title='Shopping Cart']"));
        shoppingCart.click();
